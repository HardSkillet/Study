...
namespace ChapterXXIII.Reflection
{
    public class Something
    {
        ...
        /*
         * Создание прилложений с поддержкой подключаемых компонентов:
         * 1. Создать сборку хоста, определяющего интерфейс с методами, обеспечивающими взаимодействие приложения с подключаемыми компонентами
